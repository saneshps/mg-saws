                                                                ...
                                                                <td class="padded">
                                                                    ...
                                                                    <table style="width:100%">
                                                                        <tr>
                                                                            ...
                                                                            <?php if(isset($data['category']) || isset($data['product'] )): ?>
                                                                            <p>I would like to request call back for <?php echo e($data['category']); ?>, <?php echo e($data['product']); ?></p>
                                                                            <?php endif; ?>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><strong>Name : <?php echo e($data['name']); ?></strong></td>
                                                                          
                                                                        </tr>
                                                                        <tr>
                                                                            <td><strong>Phone : <?php echo e($data['phone']); ?> <strong></td>
                                                                            
                                                                        </tr>
                                                                        <tr>
                                                                            <td><strong>Email : <?php echo e($data['email']); ?></strong></td>
                                                                            
                                                                        </tr>
                                                                        <?php if(isset($data['company'] )): ?>
                                                                        <tr>
                                                                            <td><strong>Company : <?php echo e($data['company']); ?></strong></td>
                                                                           
                                                                        </tr>
                                                                        <?php endif; ?>
                                                                        <?php if(isset($data['country'] )): ?>
                                                                        <tr>
                                                                            <td><strong>Country : <?php echo e($data['country']); ?><</strong></td>
                                                                            
                                                                        </tr>
                                                                        <?php endif; ?>
                                                                        <?php if(isset($data['message'] )): ?>
                                                                        <tr>
                                                                            <td><strong>Message</strong><br><?php echo e($data['message']); ?></td>
...
</html><?php /**PATH /homepages/27/d886905960/htdocs/resources/views/emails/contactCallBackNotification.blade.php ENDPATH**/ ?>
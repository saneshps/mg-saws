...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/css/scrolltop.css') }} ">
    <link rel="stylesheet" href="{{ asset('frontend/css/default.css') }} ">
    <link rel="stylesheet" href="{{ asset('frontend/css/wedget.css') }} ">
                            ...
                            <div class="main-menu">
                                <nav id="mobile-menu">
                                    <ul>
                                        ...
                                        <li><a href="{{ url('/all-products') }}">Products</a>
                                            <ul class="sub-menu text-left">
                                                ...
                                                <li>
                                                    <a href="{{ route('sub',$category->slug) }}">{{ $category->name }}<i class="far fa-angle-right"></i></a>

                                                    <ul class="sub-menu text-left">
                                                        @foreach ($sub_categories as $sub_category)
                                                        @if($category->id==$sub_category->parent_id)
                                                        <li><a href="{{ route('sub',$sub_category->slug) }}">{{ $sub_category->name }}
                                                            </a></li>
                                                        @endif
                                                        @endforeach
                                                    </ul>
                                                ...
                                                @else
                                                <li>
                                                    <a href="{{ route('sub',$category->slug) }}">{{ $category->name }}</a>
                                                </li>
                                                @endif
                                                @php
                                                $i++;
                                        ...
                                        <a href="{{ url('/contact-us') }}" class="btn btn-type-4"> Request A Quote <i class="fa fa-long-arrow-right"></i> </a>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 wow fadeInRight" data-wow-delay=".5s">
                            <div class="footer-single-wedget">
                                <div class="custom-html-widget">
                                    <!-- <h3>About Us</h3> -->
                                    <img src=" {{ asset('frontend/img/logo.png') }}" alt="mg logo">
                                    <img src=" {{ asset('frontend/img/yeslogo.png') }}" alt="yes logo">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 wow fadeInRight" data-wow-delay=".3s">
                            <div class="footer-single-wedget">
                                <div class="widget_nav_menu">
                                    <h3> Information </h3>
                                    <ul class="menu">
                                        <li><a href="{{ url('/all-products') }}"> <i class="fas fa-angle-double-right"></i> products </a></li>
                                        <li><a href="{{ url('/about-us') }}"><i class="fas fa-angle-double-right"></i> about us</a></li>
                                        <li><a href="{{ url('/contact-us') }}"><i class="fas fa-angle-double-right"></i> contact</a></li>
                                        <li><a href="{{ url('/blogs') }}"> <i class="fas fa-angle-double-right"></i> Blogs </a></li>
                                        <li><a href="{{ url('/faq') }}"><i class="fas fa-angle-double-right"></i> Faq </a></li>
                                        <li><a href="{{ url('/privacy-policy') }}"> <i class="fas fa-angle-double-right"></i> privacy policy</a></li>
                                        <li><a href="{{ url('/terms-and-conditions') }}"><i class="fas fa-angle-double-right"></i> terms & conditions</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="widget_nav_menu">
                                    ...
                                    <!--ul class="menu">
                                            @foreach ($allcategories as $cat)
                                                <li>
                                                    <a href="{{ url('all-all-products/sub',$cat->slug) }}"><i class="fas fa-angle-double-right"></i> {{ $cat->slug }}</a>
                                                </li>
                                            @endforeach 
                                        ...
                                        <li><a href="{{ url('about-us') }}"><i class="fas fa-angle-double-right"></i> Machining Centers</a></li>
                                        <li><a href="{{ url('contact-us') }}"><i class="fas fa-angle-double-right"></i> Copy Routers</a></li>
                                        <li><a href="{{ url('/news-and-events') }}"> <i class="fas fa-angle-double-right"></i> End Milling Machines </a></li>
                                        <li><a href="{{ url('/all-products') }}"> <i class="fas fa-angle-double-right"></i> Presses </a></li->
                                    </ul-->

                                                                ...
                                                                <td class="padded">
                                                                    ...
                                                                    <table style="width:100%">
                                                                        <tr>
                                                                            ...
                                                                            <p>I would like to request call back for {{ $data['category'] }}, {{ $data['product'] }}</p>
                                                                            @endif
                                                                        </tr>
                                                                        <tr>
                                                                            <td><strong>Name : {{ $data['name'] }}</strong></td>
                                                                          
                                                                        </tr>
                                                                        <tr>
                                                                            <td><strong>Phone : {{ $data['phone'] }} <strong></td>
                                                                            
                                                                        </tr>
                                                                        <tr>
                                                                            <td><strong>Email : {{ $data['email'] }}</strong></td>
                                                                            
                                                                        </tr>
                                                                        @if(isset($data['company'] ))
                                                                        <tr>
                                                                            <td><strong>Company : {{ $data['company'] }}</strong></td>
                                                                           
                                                                        </tr>
                                                                        @endif
                                                                        @if(isset($data['country'] ))
                                                                        <tr>
                                                                            <td><strong>Country : {{ $data['country'] }}<</strong></td>
                                                                            
                                                                        </tr>
                                                                        @endif
                                                                        @if(isset($data['message'] ))
                                                                        <tr>
                                                                            <td><strong>Message</strong><br>{{ $data['message'] }}</td>

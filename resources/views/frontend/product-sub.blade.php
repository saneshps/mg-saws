  @extends('welcome')
  @section('meta')
  <title>{{ ($catMeta && isset($catMeta->meta_title))? $catMeta->meta_title: '' }} </title>
  <meta name="description" content="{{ ($catMeta && isset($catMeta->meta_content))? $catMeta->meta_content: '' }} ">
  ...
  <section class="product-page">
      <div class="container">
          ...
          <p>{!! $current_cat->description !!}
          </p>
          <div class="row">
              @foreach ($categories as $category)

              <div class="col-md-4 col-sm-6">
                  <a href="{{ url('all-products/cat-sub/'.$category->slug) }}">
                      <div class="box">
              ...
              @endforeach
			  @if($count_categories_parent_id < 1)

        ...
        <div class="row mx-auto justify-content-center">
            <div class="col-xl-8 col-lg-8 col-md-12">
                <div class="exomos-contact-form-area">
                    <form class="exomos-contact-form" action=" {{ route('contact-us.send') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="container">
                            <div class="row">
...
<br>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                    <input class="form-control" type="text" name="company" placeholder="Company" value="{{old('company')}}">
                                ...
                                <div class="col-lg-4 col-sm-12 form-group">
                                    <input type="phone" class="form-control" name="phone" id="phone" placeholder="Your phone *" required="" value="{{old('phone')}}">
																	@error('phone')
     <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <textarea class="form-control" name="message" cols="30" rows="8" placeholder="Message">{{old('message')}}</textarea>
													@error('message')
     <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
					<br>
...
@enderror
            ...
            <div class="col-lg-4 col-lg-4 col-md-12">
                <img src="{{ asset('frontend/img/yes-certificate.jpg') }}" alt="">
            </div>

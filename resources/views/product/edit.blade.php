        ...
        <div class="col-md-6">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-10">
                            <a class="btn btn-info" style="width:100%" target="_blank" href="{{ asset('storage/'.$datasheet->file_name) }}">View Datasheet</a>
                        </div>
                        <div class="col-md-2">
    ...
    <div class="col-md-6">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <!-- <textarea class="form-control" rows="6" name="description" placeholder="Detail">{{ $product->description }}</textarea> -->
                <textarea name="metadescription" rows="6" class="form-control">{{ $product->metadescription }}</textarea>
            </div>
        </div>
        <div class="image-upload-one">
            ...
            <div class="center">
                ...
                <div class="form-group">
                    <strong>Alt:</strong>
                    <input type="text" name="image_alt" class="form-control" value="{{ $product->image_alt }}" placeholder="Alt">
                </div>
            </div>
        </div>
